...
Creates a lightweight agent, then deletes it by key.
"""
...
async def main() -> None:
    async with SDK(
        ...
        created = await pipeshub_client.agents.create_agent_async(
            ...
            description="Demo agent created by the delete_agent example.",
        ...
        # Delete the agent by key
        delete_result = await pipeshub_client.agents.delete_agent_async(agent_key=agent_key)
        print(delete_result.model_dump_json(indent=2))
