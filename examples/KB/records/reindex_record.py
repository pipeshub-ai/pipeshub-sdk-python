"""Reindex a record to refresh search indexes and embeddings."""
...
async def main() -> None:
    ...
    async with SDK(
        ...
        reindexed = await pipeshub_client.knowledge_base.reindex_record_async(
            record_id=record_id,
            force=True,
        )
        print("Reindex result:", reindexed)
