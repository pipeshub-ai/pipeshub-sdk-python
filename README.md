...
* [`OAuthErrorResponse`](./src/pipeshub/errors/oautherrorresponse.py): OAuth 2.0 Error Response (RFC 6749 Section 5.2). Standard error format for OAuth endpoints. Applicable to 5 of 291 methods.*
* [`ResetPasswordBadRequestError`](./src/pipeshub/errors/resetpasswordbadrequesterror.py): Invalid current password or weak new password. Status code `400`. Applicable to 1 of 291 methods.*
* [`SamlSignInCallbackBadRequestError`](./src/pipeshub/errors/samlsignincallbackbadrequesterror.py): Invalid SAML response. Status code `400`. Applicable to 1 of 291 methods.*
* [`UnauthorizedError`](./src/pipeshub/errors/unauthorizederror.py): SAML authentication failed. Status code `401`. Applicable to 1 of 291 methods.*
...
| ------------ | ------------------------ | ------------------------- | --------------------------------- |
| `server_url` | `server_url_global: str` | `"http://localhost:3000"` | Base server URL (without /api/v1) |
...
with Pipeshub(
    server_idx=0,
    server_url_global="http://localhost:3000",
) as p_client:
...
with Pipeshub(
    server_url="https://http://localhost:3000/api/v1",
) as p_client:
...
with Pipeshub() as p_client:
    ...
    res = p_client.open_id_connect.openid_configuration(server_url="")
...
s = Pipeshub(debug_logger=logging.getLogger("pipeshub"))
```
