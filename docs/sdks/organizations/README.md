...
with Pipeshub(
    ...
    res = p_client.organizations.get_current_organization()
...
with Pipeshub(
    ...
    res = p_client.organizations.update_organization(registered_name="Acme Corporation Inc.", short_name="Acme Corp", phone_number="+15551234567")
...
with Pipeshub(
    ...
    res = p_client.organizations.delete_organization(confirm="DELETE")
...
with Pipeshub(
    ...
    res = p_client.organizations.upload_organization_logo(logo={
...
with Pipeshub(
    ...
    res = p_client.organizations.get_organization_logo()
...
with Pipeshub(
    ...
    res = p_client.organizations.delete_organization_logo()
