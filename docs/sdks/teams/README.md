...
with Pipeshub(
    ...
    res = p_client.teams.create_team(name="Engineering Team", description="Core engineering team for product development")
...
with Pipeshub(
    ...
    res = p_client.teams.list_teams(search="engineering", limit=10, page=1)
...
with Pipeshub(
    ...
    res = p_client.teams.get_team_by_id(team_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.teams.update_team(team_id="507f1f77bcf86cd799439011", name="Core Engineering Team", description="Primary engineering team for product development")
...
with Pipeshub(
    ...
    res = p_client.teams.delete_team(team_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.teams.get_user_teams(page=1, limit=20)
...
with Pipeshub(
    ...
    res = p_client.teams.get_team_users(team_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.teams.add_users_to_team(team_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.teams.remove_user_from_team(team_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.teams.update_team_users_permissions(team_id="<id>", body={})
...
with Pipeshub(
    ...
    res = p_client.teams.get_user_created_teams()
