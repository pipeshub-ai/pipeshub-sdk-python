...
with Pipeshub(
    ...
    res = p_client.teams.create_team(security=models.CreateTeamSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), name="Engineering Team", description="Core engineering team for product development")
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.CreateTeamSecurity](../../models/createteamsecurity.md)     | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.teams.list_teams(security=models.ListTeamsSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), search="engineering", limit=10, page=1)
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.ListTeamsSecurity](../../models/listteamssecurity.md)       | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.teams.get_team_by_id(security=models.GetTeamByIDSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.GetTeamByIDSecurity](../../models/getteambyidsecurity.md)   | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.teams.update_team(security=models.UpdateTeamSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), team_id="507f1f77bcf86cd799439011", name="Core Engineering Team", description="Primary engineering team for product development")
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.UpdateTeamSecurity](../../models/updateteamsecurity.md)     | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
| `team_id`                                                           | *str*                                                               | :heavy_check_mark:                                                  | Team ID (24-character MongoDB ObjectId)                             | 507f1f77bcf86cd799439011                                            |
...
with Pipeshub(
    ...
    res = p_client.teams.delete_team(security=models.DeleteTeamSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), team_id="507f1f77bcf86cd799439011")
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.DeleteTeamSecurity](../../models/deleteteamsecurity.md)     | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.teams.get_user_teams(security=models.GetUserTeamsSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), page=1, limit=20)
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.GetUserTeamsSecurity](../../models/getuserteamssecurity.md) | :heavy_check_mark:                                                  | N/A                                                                 |
