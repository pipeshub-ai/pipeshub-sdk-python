...
with Pipeshub(
    ...
    res = p_client.connector_filters.get_connector_filters(connector_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.connector_filters.get_filter_field_options(connector_id="<id>", filter_key="folders", page=1, limit=20)
