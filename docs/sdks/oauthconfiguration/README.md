...
with Pipeshub(
    ...
    p_client.o_auth_configuration.list_toolset_o_auth_configs(toolset_type="<value>")
...
with Pipeshub(
    ...
    p_client.o_auth_configuration.update_toolset_o_auth_config(toolset_type="<value>", oauth_config_id="<id>", body={
        "key": "<value>",
        "key1": "<value>",
        "key2": "<value>",
    })
...
with Pipeshub(
    ...
    p_client.o_auth_configuration.delete_toolset_o_auth_config(toolset_type="<value>", oauth_config_id="<id>")
