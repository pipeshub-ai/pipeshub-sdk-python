...
with Pipeshub(
    ...
    res = p_client.document_management.upload_document()
...
with Pipeshub(
    ...
    res = p_client.document_management.create_placeholder_document(request={})
...
with Pipeshub(
    ...
    res = p_client.document_management.get_document_by_id(document_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.document_management.delete_document_by_id(document_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.document_management.upload_next_version_document(document_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.document_management.roll_back_to_previous_version(document_id="507f1f77bcf86cd799439011", version=2)
...
with Pipeshub(
    ...
    res = p_client.document_management.get_document_buffer(document_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.document_management.create_document_buffer_multipart(document_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.document_management.create_document_buffer_raw(document_id="<id>", body=io.BytesIO("{}".encode()))
...
with Pipeshub(
    ...
    res = p_client.document_management.upload_direct_document(document_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.document_management.document_diff_checker(document_id="<id>")
