...
with Pipeshub(
    ...
    res = p_client.document_management.download_document(security=models.DownloadDocumentSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), document_id="507f1f77bcf86cd799439011", version=2, expiration_time_in_seconds=7200)
...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `security`                                                                  | [models.DownloadDocumentSecurity](../../models/downloaddocumentsecurity.md) | :heavy_check_mark:                                                          | N/A                                                                         |                                                                             |
