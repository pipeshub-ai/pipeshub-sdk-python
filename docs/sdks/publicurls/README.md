...
with Pipeshub(
    ...
    p_client.public_ur_ls.set_frontend_public_url(url="https://app.example.com")
...
with Pipeshub(
    ...
    res = p_client.public_ur_ls.get_frontend_public_url()
...
with Pipeshub(
    ...
    p_client.public_ur_ls.set_connector_public_url(url="https://app.example.com")
...
with Pipeshub(
    ...
    res = p_client.public_ur_ls.get_connector_public_url()
