...
with Pipeshub(
    ...
    p_client.toolset_configuration.get_toolset_config(toolset_id="<id>")
...
with Pipeshub(
    ...
    p_client.toolset_configuration.save_toolset_config(toolset_id="<id>", auth={})
...
with Pipeshub(
    ...
    p_client.toolset_configuration.update_toolset_config(toolset_id="<id>", auth={})
...
with Pipeshub(
    ...
    p_client.toolset_configuration.delete_toolset_config(toolset_id="<id>")
