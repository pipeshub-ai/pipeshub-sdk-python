...
with Pipeshub(
    ...
    p_client.smtp_configuration.create_smtp_config(security=models.CreateSMTPConfigSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), host="email-smtp.us-east-1.amazonaws.com", port=587, from_email="noreply@yourcompany.com", username="AKIAIOSFODNN7EXAMPLE", password="your-ses-smtp-password")
...
with Pipeshub(
    ...
    p_client.smtp_configuration.create_smtp_config(security=models.CreateSMTPConfigSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), host="smtp.gmail.com", port=587, from_email="noreply@yourcompany.com", username="notifications@yourcompany.com", password="your-app-password")
...
with Pipeshub(
    ...
    p_client.smtp_configuration.create_smtp_config(security=models.CreateSMTPConfigSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), host="smtp.office365.com", port=587, from_email="notifications@yourcompany.onmicrosoft.com", username="notifications@yourcompany.onmicrosoft.com", password="your-password")
...
with Pipeshub(
    ...
    p_client.smtp_configuration.create_smtp_config(security=models.CreateSMTPConfigSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), host="smtp.sendgrid.net", port=587, from_email="noreply@yourcompany.com", username="apikey", password="SG.your-sendgrid-api-key")
...
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                              | [models.CreateSMTPConfigSecurity](../../models/createsmtpconfigsecurity.md)                                             | :heavy_check_mark:                                                                                                      | N/A                                                                                                                     |                                                                                                                         |
...
with Pipeshub(
    ...
    res = p_client.smtp_configuration.get_smtp_config(security=models.GetSMTPConfigSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ))
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.GetSMTPConfigSecurity](../../getsmtpconfigsecurity.md)      | :heavy_check_mark:                                                  | The security requirements to use for the request.                   |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |
