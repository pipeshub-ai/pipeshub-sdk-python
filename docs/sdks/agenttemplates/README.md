...
with Pipeshub(
    ...
    res = p_client.agent_templates.list_agent_templates()
...
with Pipeshub(
    ...
    res = p_client.agent_templates.get_agent_template(template_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.agent_templates.update_agent_template(template_id="<id>")
...
with Pipeshub(
    ...
    p_client.agent_templates.delete_agent_template(template_id="<id>")
