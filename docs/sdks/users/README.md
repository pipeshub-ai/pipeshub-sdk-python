...
with Pipeshub(
    ...
    res = p_client.users.get_all_users(page=1, limit=50)
...
with Pipeshub(
    ...
    res = p_client.users.get_user_by_id(id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.users.update_user(id="507f1f77bcf86cd799439011", full_name="John Smith", first_name="John", last_name="Smith", email="john.smith@company.com", mobile="+15551234567", designation="Senior Software Engineer")
...
with Pipeshub(
    ...
    res = p_client.users.delete_user(id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    p_client.users.update_email(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.bulk_invite_users(emails=[
        "user1@company.com",
        "user2@company.com",
    ], group_ids=[
...
with Pipeshub(
    ...
    res = p_client.users.list_users_graph(page=1, limit=10, search="john", sort_by="fullName", sort_order="asc")
...
with Pipeshub(
    ...
    res = p_client.users.get_all_users_with_groups()
...
with Pipeshub(
    ...
    res = p_client.users.get_users_by_ids()
...
with Pipeshub(
    ...
    res = p_client.users.update_full_name(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.update_first_name(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.update_last_name(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.update_designation(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.admin_check(id="<id>")
...
with Pipeshub(
    ...
    res = p_client.users.get_user_teams_via_users()
