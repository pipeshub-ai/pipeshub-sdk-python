...
with Pipeshub(
    ...
    res = p_client.users.get_all_users(security=models.GetAllUsersSecurity(
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.GetAllUsersSecurity](../../models/getalluserssecurity.md)   | :heavy_check_mark:                                                  | N/A                                                                 |
...
with Pipeshub(
    ...
    res = p_client.users.create_user(full_name="John Smith", email="john.smith@company.com", mobile="+15551234567", designation="Software Engineer", send_invite=True)
...
with Pipeshub(
    ...
    res = p_client.users.get_user_by_id(security=models.GetUserByIDSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.GetUserByIDSecurity](../../models/getuserbyidsecurity.md)   | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.users.update_user(security=models.UpdateUserSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), id="507f1f77bcf86cd799439011", full_name="John Smith", first_name="John", last_name="Smith", email="john.smith@company.com", mobile="+15551234567", designation="Senior Software Engineer")
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.UpdateUserSecurity](../../models/updateusersecurity.md)     | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | User ID (24-character MongoDB ObjectId)                             | 507f1f77bcf86cd799439011                                            |
...
with Pipeshub(
    ...
    res = p_client.users.delete_user(security=models.DeleteUserSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), id="507f1f77bcf86cd799439011")
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         | Example                                                             |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `security`                                                          | [models.DeleteUserSecurity](../../models/deleteusersecurity.md)     | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | User ID (24-character MongoDB ObjectId)                             | 507f1f77bcf86cd799439011                                            |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |                                                                     |
...
with Pipeshub(
    ...
    res = p_client.users.get_user_email_by_id(id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.users.get_user_display_picture()
...
with Pipeshub(
    ...
    res = p_client.users.remove_user_display_picture()
...
with Pipeshub(
    ...
    res = p_client.users.bulk_invite_users(security=models.BulkInviteUsersSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), emails=[
        "user1@company.com",
        "user2@company.com",
...
| Parameter                                                                 | Type                                                                      | Required                                                                  | Description                                                               | Example                                                                   |
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `security`                                                                | [models.BulkInviteUsersSecurity](../../models/bulkinviteuserssecurity.md) | :heavy_check_mark:                                                        | N/A                                                                       |                                                                           |
...
with Pipeshub(
    ...
    res = p_client.users.resend_user_invite(id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.users.list_users_graph(security=models.ListUsersGraphSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
...
| Parameter                                                                           | Type                                                                                | Required                                                                            | Description                                                                         | Example                                                                             |
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `security`                                                                          | [models.ListUsersGraphSecurity](../../models/listusersgraphsecurity.md)             | :heavy_check_mark:                                                                  | N/A                                                                                 |                                                                                     |
...
with Pipeshub(
    ...
    res = p_client.users.unblock_user(id="507f1f77bcf86cd799439011")
