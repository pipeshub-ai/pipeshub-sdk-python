...
with Pipeshub(
    ...
    res = p_client.organization_auth_config.get_auth_methods()
...
with Pipeshub(
    ...
    res = p_client.organization_auth_config.update_auth_method(auth_methods=[
        {
            "order": 195644,
            "allowed_methods": [
                {
...
with Pipeshub(
    ...
    res = p_client.organization_auth_config.set_up_auth_config(request={})
