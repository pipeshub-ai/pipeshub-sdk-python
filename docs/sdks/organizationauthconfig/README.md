...
<!-- UsageSnippet language="python" operationID="getAuthMethods" method="get" path="/api/v1/orgAuthConfig/authMethods" -->
```python
import os
...
<!-- UsageSnippet language="python" operationID="updateAuthMethod" method="post" path="/api/v1/orgAuthConfig/updateAuthMethod" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
...
<!-- UsageSnippet language="python" operationID="setUpAuthConfig" method="post" path="/api/v1/orgAuthConfig/" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
