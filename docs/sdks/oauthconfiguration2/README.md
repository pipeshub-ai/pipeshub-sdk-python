...
with Pipeshub(
    ...
    res = pipeshub.oauth_configuration.list_by_type(connector_type="<value>", page=1, limit=20)
...
with Pipeshub(
    ...
    res = pipeshub.oauth_configuration.create(connector_type="<value>", oauth_instance_name="Production Google OAuth Credentials", config={
...
with Pipeshub(
    ...
    res = pipeshub.oauth_configuration.get(connector_type="<value>", config_id="<id>")
...
with Pipeshub(
    ...
    res = pipeshub.oauth_configuration.update(connector_type="<value>", config_id="<id>")
...
with Pipeshub(
    ...
    res = pipeshub.oauth_configuration.delete(connector_type="<value>", config_id="<id>")
