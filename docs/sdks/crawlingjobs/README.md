...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.schedule_crawling_job(connector="drive", connector_id="507f1f77bcf86cd799439011", schedule_config={
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.get_crawling_job_status(connector="drive", connector_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.remove_crawling_job(connector="drive", connector_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.get_all_crawling_job_status()
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.remove_all_crawling_job()
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.pause_crawling_job(connector="drive", connector_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.resume_crawling_job(connector="drive", connector_id="507f1f77bcf86cd799439011")
...
with Pipeshub(
    ...
    res = p_client.crawling_jobs.get_queue_stats()
