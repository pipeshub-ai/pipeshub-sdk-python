...
with Pipeshub(
    ...
    res = p_client.semantic_search.search(query="API documentation examples", filters={
        "apps": [
            "drive",
        ],
    }, limit=20)
...
with Pipeshub(
    ...
    res = p_client.semantic_search.search(query="company vacation policy", limit=10)
...
with Pipeshub(
    ...
    res = p_client.semantic_search.search_history(limit=10, page=1)
...
with Pipeshub(
    ...
    res = p_client.semantic_search.delete_all_search_history()
...
with Pipeshub(
    ...
    res = p_client.semantic_search.get_search_by_id(search_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.semantic_search.delete_search_by_id(search_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.semantic_search.share_search(search_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.semantic_search.unshare_search(search_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.semantic_search.archive_search(search_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.semantic_search.unarchive_search(search_id="<value>")
