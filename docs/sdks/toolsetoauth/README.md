...
with Pipeshub(
    ...
    res = p_client.toolset_o_auth.get_toolset_o_auth_url(toolset_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.toolset_o_auth.handle_toolset_o_auth_callback()
...
with Pipeshub(
    ...
    res = p_client.toolset_o_auth.get_instance_o_auth_authorization_url(instance_id="<id>")
