...
with Pipeshub(
    ...
    res = p_client.connector_registry.get_connector_registry(scope="team", page=1, limit=20)
...
with Pipeshub(
    ...
    res = p_client.connector_registry.get_connector_schema(connector_type="google-drive")
