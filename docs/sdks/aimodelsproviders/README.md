...
with Pipeshub(
    ...
    res = p_client.ai_models_providers.get_models_by_type(model_type="embedding")
...
with Pipeshub(
    ...
    res = p_client.ai_models_providers.get_available_models_by_type(model_type="llm")
...
with Pipeshub(
    ...
    res = p_client.ai_models_providers.add_ai_model_provider(model_type="embedding", provider="openai", configuration={
        "model": "gpt-4",
...
with Pipeshub(
    ...
    p_client.ai_models_providers.update_ai_model_provider(model_type="reasoning", model_key="<value>", provider="<value>", configuration={})
...
with Pipeshub(
    ...
    p_client.ai_models_providers.set_default_ai_model(model_type="ocr", model_key="<value>")
