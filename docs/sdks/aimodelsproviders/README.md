...
with Pipeshub(
    ...
    res = pipeshub.ai_models_providers.add_ai_model_provider(model_type="embedding", provider="cohere", configuration=models.AddAIModelProviderRequestConfiguration(
        model="gpt-4",
...
| `configuration`                                                                                         | [models.AddAIModelProviderRequestConfiguration](../../models/addaimodelproviderrequestconfiguration.md) | :heavy_check_mark:                                                                                      | Provider-specific configuration. Keys vary by provider.                                                 |                                                                                                         |
