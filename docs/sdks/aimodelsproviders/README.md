...
with Pipeshub(
    ...
    pipeshub.ai_models_providers.update(model_type="embedding", model_key="<value>", provider="<value>", configuration={})
...
with Pipeshub(
    ...
    pipeshub.ai_models_providers.delete(model_type="embedding", model_key="<value>")
...
with Pipeshub(
    ...
    pipeshub.ai_models_providers.set_default(model_type="llm", model_key="<value>")
