...
with Pipeshub(
    ...
    res = p_client.metrics_collection.get_metrics_collection(security=models.GetMetricsCollectionSecurity(
...
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `security`                                                                   | [models.GetMetricsCollectionSecurity](../../getmetricscollectionsecurity.md) | :heavy_check_mark:                                                           | The security requirements to use for the request.                            |
...
with Pipeshub(
    ...
    res = p_client.metrics_collection.toggle_metrics_collection(security=models.ToggleMetricsCollectionSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `security`                                                                                | [models.ToggleMetricsCollectionSecurity](../../models/togglemetricscollectionsecurity.md) | :heavy_check_mark:                                                                        | N/A                                                                                       |                                                                                           |
