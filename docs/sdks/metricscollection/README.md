...
with Pipeshub(
    ...
    res = p_client.metrics_collection.get_metrics_collection()
...
with Pipeshub(
    ...
    res = p_client.metrics_collection.toggle_metrics_collection(enable_metric_collection=False)
...
with Pipeshub(
    ...
    res = p_client.metrics_collection.toggle_metrics_collection(enable_metric_collection=True)
