...
with Pipeshub(
    ...
    pipeshub.smtp_configurations.create_or_update(host="email-smtp.us-east-1.amazonaws.com", port=587, from_email="noreply@yourcompany.com", username="AKIAIOSFODNN7EXAMPLE", password="your-ses-smtp-password")
...
with Pipeshub(
    ...
    pipeshub.smtp_configurations.create_or_update(host="smtp.gmail.com", port=587, from_email="noreply@yourcompany.com", username="notifications@yourcompany.com", password="your-app-password")
...
with Pipeshub(
    ...
    pipeshub.smtp_configurations.create_or_update(host="smtp.office365.com", port=587, from_email="notifications@yourcompany.onmicrosoft.com", username="notifications@yourcompany.onmicrosoft.com", password="your-password")
...
with Pipeshub(
    ...
    pipeshub.smtp_configurations.create_or_update(host="smtp.sendgrid.net", port=587, from_email="noreply@yourcompany.com", username="apikey", password="SG.your-sendgrid-api-key")
