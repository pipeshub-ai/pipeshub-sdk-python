...
with Pipeshub(
    ...
    res = p_client.connector_control.toggle_connector(security=models.ToggleConnectorSecurity(
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `security`                                                                      | [models.ToggleConnectorSecurity](../../models/toggleconnectorsecurity.md)       | :heavy_check_mark:                                                              | N/A                                                                             |
