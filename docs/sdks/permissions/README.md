...
with Pipeshub(
    ...
    res = p_client.permissions.create_kb_permission(kb_id="<id>", role="OWNER")
...
with Pipeshub(
    ...
    res = p_client.permissions.list_kb_permissions(security=models.ListKBPermissionsSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), kb_id="<id>")
...
| Parameter                                                                     | Type                                                                          | Required                                                                      | Description                                                                   |
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `security`                                                                    | [models.ListKBPermissionsSecurity](../../models/listkbpermissionssecurity.md) | :heavy_check_mark:                                                            | N/A                                                                           |
| `kb_id`                                                                       | *str*                                                                         | :heavy_check_mark:                                                            | N/A                                                                           |
| `retries`                                                                     | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)              | :heavy_minus_sign:                                                            | Configuration to override the default retry behavior of the client.           |
...
with Pipeshub(
    ...
    p_client.permissions.update_kb_permissions(security=models.UpdateKBPermissionsSecurity(
        bearer_auth=os.getenv("PIPESHUB_BEARER_AUTH", ""),
    ), kb_id="<id>", role="WRITER")
...
| Parameter                                                                         | Type                                                                              | Required                                                                          | Description                                                                       |
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `security`                                                                        | [models.UpdateKBPermissionsSecurity](../../models/updatekbpermissionssecurity.md) | :heavy_check_mark:                                                                | N/A                                                                               |
| `kb_id`                                                                           | *str*                                                                             | :heavy_check_mark:                                                                | N/A                                                                               |
...
with Pipeshub(
    ...
    p_client.permissions.delete_kb_permissions(kb_id="<id>")
