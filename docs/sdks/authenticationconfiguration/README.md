...
with Pipeshub(
    ...
    pipeshub.authentication_configuration.set_microsoft(client_id="<id>", tenant_id="common")
...
with Pipeshub(
    ...
    pipeshub.authentication_configuration.set_o_auth_config(provider_name="<value>", scope="openid email profile")
