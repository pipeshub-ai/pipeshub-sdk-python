...
with Pipeshub(
    ...
    p_client.authentication_configuration.set_azure_ad_auth_config(client_id="12345678-1234-1234-1234-123456789abc", tenant_id="common")
...
with Pipeshub(
    ...
    res = p_client.authentication_configuration.get_azure_ad_auth_config()
...
with Pipeshub(
    ...
    p_client.authentication_configuration.set_microsoft_auth_config(client_id="12345678-1234-1234-1234-123456789abc", tenant_id="common")
...
with Pipeshub(
    ...
    res = p_client.authentication_configuration.get_microsoft_auth_config()
...
with Pipeshub(
    ...
    p_client.authentication_configuration.set_google_auth_config(client_id="123456789-abc.apps.googleusercontent.com")
...
with Pipeshub(
    ...
    res = p_client.authentication_configuration.get_google_auth_config()
...
with Pipeshub(
    ...
    p_client.authentication_configuration.set_sso_auth_config(entry_point="https://idp.example.com/sso/saml", email_key="email")
...
with Pipeshub(
    ...
    res = p_client.authentication_configuration.get_sso_auth_config()
...
with Pipeshub(
    ...
    p_client.authentication_configuration.set_o_auth_config(provider_name="Custom OAuth Provider", scope="openid profile email")
...
with Pipeshub(
    ...
    res = p_client.authentication_configuration.get_generic_o_auth_config()
