...
with Pipeshub(
    ...
    res = p_client.connector_configuration.get_connector_config(connector_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.connector_configuration.update_connector_config(connector_id="<id>", auth={
        "values": {
            "apiKey": "sk-xxxxx",
...
with Pipeshub(
    ...
    res = p_client.connector_configuration.update_connector_auth_config(connector_id="<id>", auth={
        "values": {
            "apiKey": "sk-xxxxx",
            "baseUrl": "https://api.example.com",
        },
...
with Pipeshub(
    ...
    res = p_client.connector_configuration.update_connector_filters_sync_config(connector_id="<id>", sync={
        "scheduled_config": {
            "cron_expression": "0 */6 * * *",
            "timezone": "America/New_York",
        },
