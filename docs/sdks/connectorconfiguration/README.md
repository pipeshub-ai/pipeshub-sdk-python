...
<!-- UsageSnippet language="python" operationID="getConnectorConfig" method="get" path="/api/v1/connectors/{connectorId}/config" -->
```python
import os
...
<!-- UsageSnippet language="python" operationID="updateConnectorConfig" method="put" path="/api/v1/connectors/{connectorId}/config" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
...
<!-- UsageSnippet language="python" operationID="updateConnectorAuthConfig" method="put" path="/api/v1/connectors/{connectorId}/config/auth" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
...
<!-- UsageSnippet language="python" operationID="updateConnectorFiltersSyncConfig" method="put" path="/api/v1/connectors/{connectorId}/config/filters-sync" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
