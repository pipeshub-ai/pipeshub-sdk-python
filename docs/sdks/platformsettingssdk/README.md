...
with Pipeshub(
    ...
    p_client.platform_settings.set_platform_settings(file_upload_max_size_bytes=31457280, feature_flags={
...
with Pipeshub(
    ...
    p_client.platform_settings.set_platform_settings(file_upload_max_size_bytes=104857600, feature_flags={
        "ENABLE_BETA_CONNECTORS": False,
    })
...
with Pipeshub(
    ...
    res = p_client.platform_settings.get_platform_settings()
...
with Pipeshub(
    ...
    p_client.platform_settings.set_custom_system_prompt()
...
with Pipeshub(
    ...
    res = p_client.platform_settings.get_custom_system_prompt()
