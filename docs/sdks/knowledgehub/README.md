...
with Pipeshub(
    ...
    res = pipeshub.knowledge_hub.get_knowledge_hub_child_nodes(parent_type="recordGroup", parent_id="507f1f77bcf86cd799439011", only_containers=False, page=1, limit=50, sort_by="updatedAt", sort_order="desc", flattened=False)
