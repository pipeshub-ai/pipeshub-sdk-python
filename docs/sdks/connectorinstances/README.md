...
with Pipeshub(
    ...
    res = p_client.connector_instances.list_connector_instances(scope="team", page=1, limit=20)
...
with Pipeshub(
    ...
    res = p_client.connector_instances.create_connector_instance(connector_type="confluence", instance_name="My Confluence", scope="personal", auth_type="API_TOKEN", config={
        "auth": {
            "values": {
                "apiKey": "sk-xxxxx",
...
with Pipeshub(
    ...
    res = p_client.connector_instances.create_connector_instance(connector_type="google-drive", instance_name="Company Google Drive", scope="team", auth_type="OAUTH_ADMIN_CONSENT", config={
        "auth": {
            "values": {
                "apiKey": "sk-xxxxx",
                "baseUrl": "https://api.example.com",
...
with Pipeshub(
    ...
    res = p_client.connector_instances.list_active_connectors()
...
with Pipeshub(
    ...
    res = p_client.connector_instances.list_inactive_connectors()
...
with Pipeshub(
    ...
    res = p_client.connector_instances.list_configured_connectors(scope="team", page=1, limit=20)
...
with Pipeshub(
    ...
    res = p_client.connector_instances.list_active_agent_connectors(scope="team", page=1, limit=20)
...
with Pipeshub(
    ...
    res = p_client.connector_instances.get_connector_instance(connector_id="conn_abc123")
...
with Pipeshub(
    ...
    res = p_client.connector_instances.delete_connector_instance(connector_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.connector_instances.update_connector_name(connector_id="<id>", instance_name="Sales Team Drive (Updated)")
