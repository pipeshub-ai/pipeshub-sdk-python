...
with Pipeshub(
    ...
    res = p_client.folders.create_root_folder(kb_id="<id>", folder_name="Project Documents")
...
with Pipeshub(
    ...
    res = p_client.folders.get_folder_contents(kb_id="<id>", folder_id="<id>", page=1, limit=20, sort_by="createdAtTimestamp", sort_order="desc")
...
with Pipeshub(
    ...
    res = p_client.folders.update_folder(kb_id="<id>", folder_id="<id>", folder_name="<value>")
...
with Pipeshub(
    ...
    p_client.folders.delete_folder(kb_id="<id>", folder_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.folders.get_folder_children(kb_id="<id>", folder_id="<id>", page=1, limit=20, sort_by="createdAtTimestamp", sort_order="desc")
...
with Pipeshub(
    ...
    res = p_client.folders.create_subfolder(kb_id="<id>", folder_id="<id>", folder_name="<value>")
