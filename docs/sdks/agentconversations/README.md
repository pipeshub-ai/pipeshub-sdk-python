...
with Pipeshub(
    ...
    res = p_client.agent_conversations.list_agent_conversations(agent_key="<value>")
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.create_agent_conversation(agent_key="<value>", query="What are the key findings from our Q4 financial report?", record_ids=[
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.stream_agent_conversation(agent_key="<value>", query="What are the key findings from our Q4 financial report?", record_ids=[
        "507f1f77bcf86cd799439011",
        "507f1f77bcf86cd799439012",
    ], model_key="gpt-4-turbo", model_name="GPT-4 Turbo", chat_mode="balanced")
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.get_agent_conversation(agent_key="<value>", conversation_id="<value>")
...
with Pipeshub(
    ...
    p_client.agent_conversations.delete_agent_conversation(agent_key="<value>", conversation_id="<value>")
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.add_agent_message(agent_key="<value>", conversation_id="<value>", query="Can you elaborate on the revenue trends?")
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.stream_agent_message(agent_key="<value>", conversation_id="<value>", query="Can you elaborate on the revenue trends?")
...
with Pipeshub(
    ...
    res = p_client.agent_conversations.regenerate_agent_answer(agent_key="<value>", conversation_id="<value>", message_id="<value>")
