...
<!-- UsageSnippet language="python" operationID="uploadRecordsToKB" method="post" path="/api/v1/knowledgeBase/{kbId}/upload" -->
```python
import os
...
<!-- UsageSnippet language="python" operationID="uploadRecordsToFolder" method="post" path="/api/v1/knowledgeBase/{kbId}/folder/{folderId}/upload" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
...
<!-- UsageSnippet language="python" operationID="getUploadLimits" method="get" path="/api/v1/knowledgeBase/limits" -->
```python
import os
from pipeshub_sdk import Pipeshub, models
