...
with Pipeshub(
    ...
    res = p_client.upload.upload_records_to_kb(kb_id="<id>", files=[
        {
...
with Pipeshub(
    ...
    res = p_client.upload.upload_records_to_folder(kb_id="<id>", folder_id="<id>", files=[
        {
            "file_name": "example.file",
            "content": open("example.file", "rb"),
        },
...
with Pipeshub(
    ...
    res = p_client.upload.get_upload_limits()
