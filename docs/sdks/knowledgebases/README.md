...
with Pipeshub(
    ...
    res = pipeshub.knowledge_bases.move(kb_id="702f8ff0-0a01-4354-b592-eea268f40f25", record_id="<id>", body={})
...
with Pipeshub(
    ...
    res = pipeshub.knowledge_bases.move(kb_id="8bdbd4fc-ec2e-4e15-8a88-ae59a5b4bad2", record_id="<id>", body={})
