...
with Pipeshub(
    ...
    res = p_client.storage_configuration.get_storage_config(security=models.GetStorageConfigSecurity(
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `security`                                                           | [models.GetStorageConfigSecurity](../../getstorageconfigsecurity.md) | :heavy_check_mark:                                                   | The security requirements to use for the request.                    |
