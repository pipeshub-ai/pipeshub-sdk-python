...
with Pipeshub(
    ...
    res = p_client.records.get_all_records(page=1, limit=20, record_types="FILE,WEBPAGE,EMAIL", connectors="GOOGLE_DRIVE,ONEDRIVE", indexing_status="COMPLETED,FAILED", sort_by="createdAtTimestamp", sort_order="desc")
...
with Pipeshub(
    ...
    res = p_client.records.get_kb_records(kb_id="<id>", page=1, limit=20, sort_by="createdAtTimestamp", sort_order="desc")
...
with Pipeshub(
    ...
    res = p_client.records.get_kb_children(kb_id="<id>", page=1, limit=20, sort_by="createdAtTimestamp", sort_order="desc")
...
with Pipeshub(
    ...
    res = p_client.records.get_record_by_id(record_id="<id>", convert_to="txt")
...
with Pipeshub(
    ...
    p_client.records.delete_record(record_id="<id>")
...
with Pipeshub(
    ...
    res = p_client.records.stream_record_buffer(record_id="<id>")
