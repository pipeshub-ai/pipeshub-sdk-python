...
class UserAccount(BaseSDK):
    ...
    def validate_email_change_token(
        ...
        *,
        security: Union[
            models.ValidateEmailChangeTokenSecurity,
            models.ValidateEmailChangeTokenSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ValidateEmailChangeTokenResponse:
        r"""Validate email change token
        ...
        req = self._build_request(
            method="PUT",
            path="/userAccount/validateEmailChange",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="validateEmailChangeToken",
                oauth2_scopes=None,
                security_source=get_security_from_env(security, models.Security),
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ValidateEmailChangeTokenResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.AuthErrorData, http_res)
            raise errors.AuthError(response_data, http_res)
    ...
    async def validate_email_change_token_async(
        self,
        *,
        security: Union[
            models.ValidateEmailChangeTokenSecurity,
