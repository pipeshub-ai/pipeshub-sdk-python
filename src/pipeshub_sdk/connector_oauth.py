...
class ConnectorOAuth(BaseSDK):
    ...
    def get_o_auth_authorization_url(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/{connectorId}/oauth/authorize",
            base_url=base_url_,
    ...
    def handle_o_auth_callback(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/oauth/callback",
            base_url=base_url_,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def get_token_from_code(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/connectors/getTokenFromCode",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
