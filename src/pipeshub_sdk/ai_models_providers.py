...
class AIModelsProviders(BaseSDK):
    ...
    def get_models_by_type(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/configurationManager/ai-models/{modelType}",
            base_url=base_url,
    ...
    def get_available_models_by_type(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/configurationManager/ai-models/available/{modelType}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def add_ai_model_provider(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/configurationManager/ai-models/providers",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
    ...
    def update_ai_model_provider(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/configurationManager/ai-models/providers/{modelType}/{modelKey}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def set_default_ai_model(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/configurationManager/ai-models/default/{modelType}/{modelKey}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
