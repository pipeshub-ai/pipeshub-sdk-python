...
class ConnectorConfiguration(BaseSDK):
    ...
    def get_connector_config(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/{connectorId}/config",
            base_url=base_url,
    ...
    def update_connector_auth_config(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/connectors/{connectorId}/config/auth",
            base_url=base_url_,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def update_connector_filters_sync_config(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/connectors/{connectorId}/config/filters-sync",
            base_url=base_url_,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
