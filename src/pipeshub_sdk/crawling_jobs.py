    ...
    **Schedule Types:**
    ...
    def schedule_crawling_job(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/crawlingManager/{connector}/{connectorId}/schedule",
            base_url=base_url,
    ...
    def remove_crawling_job(
        ...
        *,
        ...
        req = self._build_request(
            method="DELETE",
            path="/api/v1/crawlingManager/{connector}/{connectorId}/remove",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def get_all_crawling_job_status(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/crawlingManager/schedule/all",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
    ...
    def pause_crawling_job(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/crawlingManager/{connector}/{connectorId}/pause",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def resume_crawling_job(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/crawlingManager/{connector}/{connectorId}/resume",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def get_queue_stats(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/crawlingManager/stats",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
