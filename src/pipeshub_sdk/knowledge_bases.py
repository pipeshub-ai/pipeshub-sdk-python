...
class KnowledgeBases(BaseSDK):
    ...
    def get_knowledge_base(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/knowledgeBase/{kbId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def reindex_failed_records(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/knowledgeBase/reindex-failed/connector",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def move_record(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/knowledgeBase/{kbId}/record/{recordId}/move",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
