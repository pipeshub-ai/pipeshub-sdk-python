...
class AgentConversations(BaseSDK):
    ...
    def stream_agent_conversation(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/agents/{agentKey}/conversations/stream",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def get_agent_conversation(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/agents/{agentKey}/conversations/{conversationId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def stream_agent_message(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/agents/{agentKey}/conversations/{conversationId}/messages/stream",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def regenerate_agent_answer(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/agents/{agentKey}/conversations/{conversationId}/message/{messageId}/regenerate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
