    ...
    **App Lifecycle:**
    ...
    def list_o_auth_scopes(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/oauth-clients/scopes",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
    ...
    def get_o_auth_app(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/oauth-clients/{appId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def regenerate_o_auth_app_secret(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/oauth-clients/{appId}/regenerate-secret",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def suspend_o_auth_app(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/oauth-clients/{appId}/suspend",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def activate_o_auth_app(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/oauth-clients/{appId}/activate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def list_o_auth_app_tokens(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/oauth-clients/{appId}/tokens",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def revoke_all_o_auth_app_tokens(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/oauth-clients/{appId}/revoke-all-tokens",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
