...
class ConnectorInstances(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        :param oauth_config_id: ID of admin-created OAuth App to use (required for non-admin users creating OAuth connectors, optional for admins)
