    ...
    def stream_record_buffer(
        ...
        **Format conversion:**
        ...
        if utils.match_response(http_res, "403", "application/json"):
            http_res_text = utils.stream_to_text(http_res)
            response_data = unmarshal_json_response(
                errors.ForbiddenUnion, http_res, http_res_text
            )
            raise errors.Forbidden(response_data, http_res, http_res_text)
        if utils.match_response(http_res, ["404", "409"], "application/json"):
            http_res_text = utils.stream_to_text(http_res)
            response_data = unmarshal_json_response(
                errors.StreamRecordErrorResponseData, http_res, http_res_text
            )
            raise errors.StreamRecordErrorResponse(
