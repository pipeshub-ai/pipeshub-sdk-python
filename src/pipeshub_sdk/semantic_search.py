...
class SemanticSearch(BaseSDK):
    ...
    def share_search(
        ...
        *,
        ...
        req = self._build_request(
            method="PATCH",
            path="/api/v1/search/{searchId}/share",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def unshare_search(
        ...
        *,
        ...
        req = self._build_request(
            method="PATCH",
            path="/api/v1/search/{searchId}/unshare",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def archive_search(
        ...
        *,
        ...
        req = self._build_request(
            method="PATCH",
            path="/api/v1/search/{searchId}/archive",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def unarchive_search(
        ...
        *,
        ...
        req = self._build_request(
            method="PATCH",
            path="/api/v1/search/{searchId}/unarchive",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
