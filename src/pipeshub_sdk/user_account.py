...
class UserAccount(BaseSDK):
    ...
    def reset_password_with_token(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/userAccount/password/reset/token",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
    ...
    def logout(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/userAccount/logout/manual",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
