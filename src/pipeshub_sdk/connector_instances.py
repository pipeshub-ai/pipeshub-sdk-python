...
class ConnectorInstances(BaseSDK):
    ...
    def list_inactive_connectors(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/inactive",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
    ...
    def list_configured_connectors(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/configured",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def list_active_agent_connectors(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/connectors/agents/active",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def update_connector_name(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/api/v1/connectors/{connectorId}/name",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
