...
class WebSearchSDK(BaseSDK):
    ...
    def get_web_search_providers(
        ...
        *,
        ...
        r"""Get all web search providers
        ...
        **Authentication:** Session JWT or OAuth 2.0 access token via `Authorization: Bearer`.
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getWebSearchProviders",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.WebSearchProvidersResponse, http_res)
    ...
    async def get_web_search_providers_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
