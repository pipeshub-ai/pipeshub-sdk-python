...
AgentMessageStreamSSEEventEvent = Union[
    Literal[
        "connected",
        "status",
        "tool_calls",
...
class AgentMessageStreamSSEEventTypedDict(TypedDict):
    r"""Server-Sent Event envelope for `POST /agents/{agentKey}/conversations/{conversationId}/messages/stream`.
    ...
    event: NotRequired[AgentMessageStreamSSEEventEvent]
    data: NotRequired[Any]
    r"""JSON-encoded event payload. Shape depends on `event`."""


class AgentMessageStreamSSEEvent(BaseModel):
    r"""Server-Sent Event envelope for `POST /agents/{agentKey}/conversations/{conversationId}/messages/stream`.
    `data` is a JSON-encoded string whose shape depends on `event`.
    ...
    event: Optional[AgentMessageStreamSSEEventEvent] = None
