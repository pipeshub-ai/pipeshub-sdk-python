...
class CreateConversationMetaTypedDict(TypedDict):
    request_id: NotRequired[str]
    timestamp: NotRequired[datetime]
    duration: NotRequired[int]


class CreateConversationMeta(BaseModel):
...
class CreateConversationResponseTypedDict(TypedDict):
    r"""Conversation created successfully"""
    ...
    """
    meta: NotRequired[CreateConversationMetaTypedDict]
...
class CreateConversationResponse(BaseModel):
    ...
    meta: Optional[CreateConversationMeta] = None
...
try:
    CreateConversationMeta.model_rebuild()
except NameError:
    pass
