...
AgentDefaultReasoningEffort = Union[
    Literal[
        "none",
        "low",
        "medium",
...
class AgentTypedDict(TypedDict):
    ...
    r"""MCP server instances linked to the agent (GET /agents/{agentKey} graph
    ...
    skills: List[AgentSkillTypedDict]
    r"""Skills linked to the agent via `agentHasSkill` edges"""
    share_with_org: bool
...
class Agent(BaseModel):
    ...
    default_reasoning_effort: Annotated[
        OptionalNullable[AgentDefaultReasoningEffort],
