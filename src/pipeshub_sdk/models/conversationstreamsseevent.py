...
ConversationStreamSSEEventEvent = Union[
    Literal[
        "RUN_STARTED",
        "RUN_FINISHED",
        "RUN_ERROR",
...
class ConversationStreamSSEEventTypedDict(TypedDict):
    r"""Server-Sent Event envelope for public conversation streams using
...
class ConversationStreamSSEEvent(BaseModel):
    r"""Server-Sent Event envelope for public conversation streams using
    `agent`, `internal_search`, or `web_search`. AG-UI is the sole wire
    protocol.
