...
from pipeshub.utils import FieldMetadata, MultipartFormMetadata, SecurityMetadata
import pydantic
...
class UploadOrganizationLogoSecurityTypedDict(TypedDict):
    bearer_auth: NotRequired[str]
    oauth2: NotRequired[SchemeOauth2TypedDict]


class UploadOrganizationLogoSecurity(BaseModel):
