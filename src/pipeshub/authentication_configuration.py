...
class AuthenticationConfiguration(BaseSDK):
    ...
    def set_azure_ad_auth_config(
        ...
        *,
        security: Union[
            models.SetAzureAdAuthConfigSecurity,
            models.SetAzureAdAuthConfigSecurityTypedDict,
        ],
        client_id: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.SetAzureAdAuthConfigSecurity
            ),
    ...
    def get_azure_ad_auth_config(
        ...
        *,
        security: Union[
            models.GetAzureAdAuthConfigSecurity,
            models.GetAzureAdAuthConfigSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetAzureAdAuthConfigSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def set_microsoft_auth_config(
        ...
        *,
        security: Union[
            models.SetMicrosoftAuthConfigSecurity,
            models.SetMicrosoftAuthConfigSecurityTypedDict,
        ],
        client_id: str,
        tenant_id: Optional[str] = "common",
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.SetMicrosoftAuthConfigSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def get_microsoft_auth_config(
        ...
        *,
        security: Union[
            models.GetMicrosoftAuthConfigSecurity,
            models.GetMicrosoftAuthConfigSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetMicrosoftAuthConfigSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def set_google_auth_config(
        ...
        *,
        security: Union[
            models.SetGoogleAuthConfigSecurity,
            models.SetGoogleAuthConfigSecurityTypedDict,
        ],
        client_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.SetGoogleAuthConfigSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def get_google_auth_config(
        ...
        *,
        security: Union[
            models.GetGoogleAuthConfigSecurity,
            models.GetGoogleAuthConfigSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetGoogleAuthConfigSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def set_sso_auth_config(
        ...
        *,
        security: Union[
            models.SetSsoAuthConfigSecurity, models.SetSsoAuthConfigSecurityTypedDict
        ],
        entry_point: str,
        certificate: str,
        email_key: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.SetSsoAuthConfigSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def get_sso_auth_config(
        ...
        *,
        security: Union[
            models.GetSsoAuthConfigSecurity, models.GetSsoAuthConfigSecurityTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetSsoAuthConfigSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def set_o_auth_config(
        ...
        *,
        security: Union[
            models.SetOAuthConfigSecurity, models.SetOAuthConfigSecurityTypedDict
        ],
        provider_name: str,
        client_id: str,
        ...
        req = self._build_request(
            ...
            accept_header_value="*/*",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.SetOAuthConfigSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def get_generic_o_auth_config(
        ...
        *,
        security: Union[
            models.GetGenericOAuthConfigSecurity,
            models.GetGenericOAuthConfigSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetGenericOAuthConfigSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
