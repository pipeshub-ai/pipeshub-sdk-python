...
class Permissions(BaseSDK):
    ...
    def list_kb_permissions(
        ...
        *,
        security: Union[
            models.ListKBPermissionsSecurity, models.ListKBPermissionsSecurityTypedDict
        ],
        kb_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListKBPermissionsSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_kb_permissions(
        ...
        *,
        security: Union[
            models.UpdateKBPermissionsSecurity,
            models.UpdateKBPermissionsSecurityTypedDict,
        ],
        kb_id: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UpdateKBPermissionsSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body,
                False,
