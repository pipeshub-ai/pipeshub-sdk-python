...
class KnowledgeBases(BaseSDK):
    ...
    def create_knowledge_base(
        ...
        *,
        security: Union[
            models.CreateKnowledgeBaseSecurity,
            models.CreateKnowledgeBaseSecurityTypedDict,
        ],
        kb_name: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.CreateKnowledgeBaseSecurity
            ),
    ...
    def list_knowledge_bases(
        ...
        *,
        security: Union[
            models.ListKnowledgeBasesSecurity,
            models.ListKnowledgeBasesSecurityTypedDict,
        ],
        page: Optional[int] = 1,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.ListKnowledgeBasesSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_knowledge_base(
        ...
        *,
        security: Union[
            models.GetKnowledgeBaseSecurity, models.GetKnowledgeBaseSecurityTypedDict
        ],
        kb_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetKnowledgeBaseSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_knowledge_base(
        ...
        *,
        security: Union[
            models.UpdateKnowledgeBaseSecurity,
            models.UpdateKnowledgeBaseSecurityTypedDict,
        ],
        kb_id: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UpdateKnowledgeBaseSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body,
                False,
    ...
    def delete_knowledge_base(
        ...
        *,
        security: Union[
            models.DeleteKnowledgeBaseSecurity,
            models.DeleteKnowledgeBaseSecurityTypedDict,
        ],
        kb_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.DeleteKnowledgeBaseSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_knowledge_hub_root_nodes(
        ...
        *,
        security: Union[
            models.GetKnowledgeHubRootNodesSecurity,
            models.GetKnowledgeHubRootNodesSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetKnowledgeHubRootNodesSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_knowledge_hub_child_nodes(
        ...
        *,
        security: Union[
            models.GetKnowledgeHubChildNodesSecurity,
            models.GetKnowledgeHubChildNodesSecurityTypedDict,
        ],
        parent_type: str,
        parent_id: str,
        page: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetKnowledgeHubChildNodesSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
