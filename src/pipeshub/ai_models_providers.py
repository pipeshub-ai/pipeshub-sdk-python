...
class AIModelsProviders(BaseSDK):
    ...
    def get_models_by_type(
        ...
        *,
        security: Union[
            models.GetModelsByTypeSecurity, models.GetModelsByTypeSecurityTypedDict
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.GetModelsByTypeSecurity),
    ...
    def get_available_models_by_type(
        ...
        *,
        security: Union[
            models.GetAvailableModelsByTypeSecurity,
            models.GetAvailableModelsByTypeSecurityTypedDict,
        ],
        model_type: models.ModelType,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GetAvailableModelsByTypeSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def add_ai_model_provider(
        ...
        *,
        security: Union[
            models.AddAIModelProviderSecurity,
            models.AddAIModelProviderSecurityTypedDict,
        ],
        model_type: models.ModelType,
        provider: str,
        configuration: Union[
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.AddAIModelProviderSecurity
            ),
    ...
    def update_ai_model_provider(
        ...
        *,
        security: Union[
            models.UpdateAIModelProviderSecurity,
            models.UpdateAIModelProviderSecurityTypedDict,
        ],
        model_type: models.ModelType,
        model_key: str,
        provider: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UpdateAIModelProviderSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def set_default_ai_model(
        ...
        *,
        security: Union[
            models.SetDefaultAIModelSecurity, models.SetDefaultAIModelSecurityTypedDict
        ],
        model_type: models.ModelType,
        model_key: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.SetDefaultAIModelSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
