...
class Upload(BaseSDK):
    ...
    def upload_records_to_kb(
        ...
        *,
        security: Union[
            models.UploadRecordsToKBSecurity, models.UploadRecordsToKBSecurityTypedDict
        ],
        kb_id: str,
        files: Union[
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.UploadRecordsToKBSecurity
            ),
    ...
    def upload_records_to_folder(
        ...
        *,
        security: Union[
            models.UploadRecordsToFolderSecurity,
            models.UploadRecordsToFolderSecurityTypedDict,
        ],
        kb_id: str,
        folder_id: str,
        files: Union[
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UploadRecordsToFolderSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body,
                False,
    ...
    def get_upload_limits(
        ...
        *,
        security: Union[
            models.GetUploadLimitsSecurity, models.GetUploadLimitsSecurityTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.GetUploadLimitsSecurity),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
