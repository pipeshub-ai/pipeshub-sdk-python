...
class AgentTemplates(BaseSDK):
    ...
    def list_agent_templates(
        ...
        *,
        security: Union[
            models.ListAgentTemplatesSecurity,
            models.ListAgentTemplatesSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListAgentTemplatesSecurity
            ),
    ...
    def get_agent_template(
        ...
        *,
        security: Union[
            models.GetAgentTemplateSecurity, models.GetAgentTemplateSecurityTypedDict
        ],
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetAgentTemplateSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_agent_template(
        ...
        *,
        security: Union[
            models.UpdateAgentTemplateSecurity,
            models.UpdateAgentTemplateSecurityTypedDict,
        ],
        template_id: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UpdateAgentTemplateSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body,
                False,
    ...
    def delete_agent_template(
        ...
        *,
        security: Union[
            models.DeleteAgentTemplateSecurity,
            models.DeleteAgentTemplateSecurityTypedDict,
        ],
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.DeleteAgentTemplateSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
