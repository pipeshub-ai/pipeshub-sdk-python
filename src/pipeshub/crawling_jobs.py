...
class CrawlingJobs(BaseSDK):
    ...
    **Schedule Types:**
    ...
    def schedule_crawling_job(
        ...
        *,
        security: Union[
            models.ScheduleCrawlingJobSecurity,
            models.ScheduleCrawlingJobSecurityTypedDict,
        ],
        connector: str,
        connector_id: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ScheduleCrawlingJobSecurity
            ),
    ...
    def get_crawling_job_status(
        ...
        *,
        security: Union[
            models.GetCrawlingJobStatusSecurity,
            models.GetCrawlingJobStatusSecurityTypedDict,
        ],
        connector: str,
        connector_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetCrawlingJobStatusSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def remove_crawling_job(
        ...
        *,
        security: Union[
            models.RemoveCrawlingJobSecurity, models.RemoveCrawlingJobSecurityTypedDict
        ],
        connector: str,
        connector_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.RemoveCrawlingJobSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
