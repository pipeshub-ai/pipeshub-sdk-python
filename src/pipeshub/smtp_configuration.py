...
class SMTPConfiguration(BaseSDK):
    ...
    def create_smtp_config(
        ...
        *,
        security: Union[
            models.CreateSMTPConfigSecurity, models.CreateSMTPConfigSecurityTypedDict
        ],
        host: str,
        port: int,
        from_email: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.CreateSMTPConfigSecurity
            ),
    ...
    def get_smtp_config(
        ...
        *,
        security: Union[
            models.GetSMTPConfigSecurity, models.GetSMTPConfigSecurityTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.GetSMTPConfigSecurity),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
