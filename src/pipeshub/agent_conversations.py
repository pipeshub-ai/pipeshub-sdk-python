...
class AgentConversations(BaseSDK):
    ...
    def list_agent_conversations(
        ...
        *,
        security: Union[
            models.ListAgentConversationsSecurity,
            models.ListAgentConversationsSecurityTypedDict,
        ],
        agent_key: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListAgentConversationsSecurity
            ),
    ...
    def create_agent_conversation(
        ...
        *,
        security: Union[
            models.CreateAgentConversationSecurity,
            models.CreateAgentConversationSecurityTypedDict,
        ],
        agent_key: str,
        query: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.CreateAgentConversationSecurity
            ),
    ...
    def stream_agent_conversation(
        ...
        *,
        security: Union[
            models.StreamAgentConversationSecurity,
            models.StreamAgentConversationSecurityTypedDict,
        ],
        agent_key: str,
        query: str,
        record_ids: Optional[List[str]] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.StreamAgentConversationSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.CreateConversationRequest
            ),
    ...
    def get_agent_conversation(
        ...
        *,
        security: Union[
            models.GetAgentConversationSecurity,
            models.GetAgentConversationSecurityTypedDict,
        ],
        agent_key: str,
        conversation_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetAgentConversationSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def delete_agent_conversation(
        ...
        *,
        security: Union[
            models.DeleteAgentConversationSecurity,
            models.DeleteAgentConversationSecurityTypedDict,
        ],
        agent_key: str,
        conversation_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.DeleteAgentConversationSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def add_agent_message(
        ...
        *,
        security: Union[
            models.AddAgentMessageSecurity, models.AddAgentMessageSecurityTypedDict
        ],
        agent_key: str,
        conversation_id: str,
        query: str,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.AddAgentMessageSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def stream_agent_message(
        ...
        *,
        security: Union[
            models.StreamAgentMessageSecurity,
            models.StreamAgentMessageSecurityTypedDict,
        ],
        agent_key: str,
        conversation_id: str,
        query: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.StreamAgentMessageSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.AddMessageRequest
            ),
    ...
    def regenerate_agent_answer(
        ...
        *,
        security: Union[
            models.RegenerateAgentAnswerSecurity,
            models.RegenerateAgentAnswerSecurityTypedDict,
        ],
        agent_key: str,
        conversation_id: str,
        message_id: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.RegenerateAgentAnswerSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
