...
class SemanticSearch(BaseSDK):
    ...
    def search(
        self,
        *,
        security: Union[models.SearchSecurity, models.SearchSecurityTypedDict],
        query: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.SearchSecurity),
    ...
    def search_history(
        ...
        *,
        security: Union[
            models.SearchHistorySecurity, models.SearchHistorySecurityTypedDict
        ],
        limit: Optional[int] = 10,
        page: Optional[int] = 1,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.SearchHistorySecurity),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def delete_all_search_history(
        ...
        *,
        security: Union[
            models.DeleteAllSearchHistorySecurity,
            models.DeleteAllSearchHistorySecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.DeleteAllSearchHistorySecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
